        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-header">
                   <h1>Consultar mi Nota final</h1>
                </div>
                <div class="card-body">
                <form action="" method="post">
                    <div class="form-group">
                    <label for="email">Nota 1</label>
                    <input type="text" class="form-control" id="email" placeholder=" primera nota" name="nota1">
                    </div>
                    <div class="form-group">
                    <label for="pwd">Nota 2:</label>
                    <input type="text" class="form-control" id="pwd" placeholder=" segunda nota" name="nota2">
                    </div>
                    <div class="form-group">
                    <label for="pwd">Nota 3:</label>
                    <input type="text" class="form-control" id="pwd" placeholder=" tercera nota" name="nota3">
                    </div>
                    <center>
