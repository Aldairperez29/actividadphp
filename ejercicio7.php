        ...
        <div class="col-md-7">
            <div class="card">
                ...
                <form action="" method="post">
                    ...
                    <input type="text" class="form-control" id="email" placeholder=" dia" name="var1">
                    </div>
                    <div class="form-group">
                    <label for="pwd">Mes:</label>
                    <input type="text" class="form-control" id="pwd" placeholder=" mes" name="var2">
                    </div>
                    <div class="form-group">
                    <label for="pwd">Año:</label>
                    <input type="text" class="form-control" id="pwd" placeholder=" año" name="var3">
                    </div>
                    <center>
